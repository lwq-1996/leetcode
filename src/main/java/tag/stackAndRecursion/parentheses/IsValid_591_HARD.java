 ...
 * @Filename: IsValid_591_HARD
 * @Author: LWQ
 * @Data: 2024/1/13 15:02
 * @Description: hard
 */
...
public class IsValid_591_HARD {
    ...
    public static void main(String[] args) {
        IsValid_591_HARD target = new IsValid_591_HARD();
        String code = "<DIV>This is the first line <![CDATA[<div>]]></DIV>";
        boolean result = target.isValid(code);
